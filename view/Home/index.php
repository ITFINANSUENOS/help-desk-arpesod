                                ...
                                <table class="table table-bordered table-striped table-vcenter js-dataTable-full">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center" title="Errores Recibidos (Proceso / Info)"><i class="fa fa-times-circle"></i> Recibidos</th>
                                            <th class="text-center" title="Errores Reportados (Proceso / Info)"><i class="fa fa-bullhorn"></i> Reportados</th>
                                        </tr>
                                    </thead>
